...
const sampleProducts = [
  ...
  { id: 15, name: 'Figura de Deadpool with Wolverine Photo', category: 'Funko', price: 76, available: true },
  ...
  { id: 29, name: 'Figura Pickle Rick with Laser', category: 'Funko', price: 45, available: true },
